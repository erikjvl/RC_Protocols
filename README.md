...
Example channel configuration. Always use a fixed 68%, 27% or 3% weight in a single channel mix and addept the order of the swithces to fit your own preferences.
